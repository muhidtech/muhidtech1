        ...
        <AnimatePresence>
          {loading &&
            [...Array(6)].map((_, i) => (
              <div
                key={i}
                className="animate-pulse bg-white/5 rounded-2xl p-5 border border-white/10 h-[320px]"
              >
                <div className="bg-gray-700 h-48 w-full rounded-xl mb-4" />
                <div className="h-5 bg-gray-600 rounded w-3/4 mb-2" />
                <div className="h-3 bg-gray-600 rounded w-full mb-3" />
                <div className="flex gap-2">
                  <div className="h-4 w-12 bg-gray-600 rounded-full" />
          ...
          {error && (
            <div className="col-span-full text-center text-red-400 text-sm mt-5">
              {error}
            </div>
          )}
          ...
          {!loading &&
            ...
            filteredProjects.map((project) => (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-md rounded-2xl p-5 border border-white/10 hover:scale-[1.02] transition overflow-hidden flex flex-col justify-between"
              >
